...
**Question B — Document verification.** *Can the agent check that a submitted onboarding document (NBI clearance, SSS, Pag-IBIG, BIR 2316, PhilHealth, APE) is the right type and has all required fields filled in?*
