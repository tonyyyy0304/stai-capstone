"""Content for dlsu-faculty-preboarding-process.pdf.
...
DOC = {
 "doc_id": "dlsu-faculty-preboarding-process",
 "title": "DLSU Faculty Pre-boarding Process Guide",
 "category": "onboarding",
 "effective_date": "2025",
 "version": "1.0",
 "author": "DLSU Human Resources Management Office (HRMO)",
 "running_head": "DLSU Faculty Pre-boarding Process Guide -- 2025",
}

BLOCKS = [
 ("h1", "DLSU Faculty Pre-boarding Process Guide"),
 ("p",
 ...
 "different pre-boarding path; see §3 for a class-by-class breakdown. "
 "If your appointment type is unclear, ask your Department Chair before "
 "assuming any single track applies to you."),

 ("h2", "1. The Six Stages of Pre-boarding"),
 ("p",
 "Pre-boarding at DLSU runs through six stages, from initial screening to "
 "first-day orientation. The stages are the same in sequence across "
 "faculty classes; what differs is which documents are required and how "
 "much lead time each stage takes (§3)."),
 ("table", ([
 ["Stage", "What happens", "Typical office of record"],
 ...
 ("p",
 "Academic-track candidates deliver a teaching demonstration evaluated by "
 "a College panel that typically includes the Department Chair, a senior "
 "faculty member, and a College Dean's Office representative. Academic "
 "Service Faculty (ASF) candidates, who are hired for non-teaching "
 "academic-support roles, undergo a competency interview in place of a "
 "teaching demonstration; see §3.3. The panel's recommendation feeds "
 "directly into the conditional offer decision in Stage 3."),

 ("h3", "2.3 Conditional Job Offer"),
 ("p",
 "The College Dean's Office issues a conditional offer letter specifying "
 "rank, load, and start date. The offer is explicitly conditional on (a) "
 "submission of a complete document set within the stated deadline, "
 "usually 15 working days from the offer date, and (b) clean or "
 "acceptable results on the government and previous-employer clearances "
 "described in §4. Candidates should not resign from a current position "
 "or make relocation commitments before clearance results are confirmed."),
 ...
 "same as validation. Validation (e.g., NBI Clearance freshness, name "
 "matching) happens in Stage 5."),

 ("h3", "2.5 Clearance and Contract Finalization"),
 ("p",
 ...
 "appointment paper (for ASF), which the candidate signs before the "
 "start date."),
 ...
 ("table", ([
 ["Party", "Responsibility during pre-boarding"],
 ["Candidate / New hire", "Submits complete, legible documents by the stated deadline; responds to HRMO follow-ups within 3 working days; confirms availability for the start date."],
 ["Department Chair", "Conducts initial screening and teaching-demonstration evaluation; recommends rank and load; is the candidate's first point of contact for process questions."],
 ["College Dean's Office", "Issues the conditional offer; approves final rank and start date; signs off on College-level hiring criteria compliance."],
 ["HRMO", "Owns the master pre-boarding checklist; verifies document completeness; coordinates clearance results; schedules orientation; is the escalation point if a stage stalls."],
 ["Legal Affairs", "Prepares and finalizes the employment contract or appointment paper once all clearances are confirmed."],
 ], [2.2, 7.0])),

 ("h2", "5. Indicative Pre-boarding Timeline"),
 ("p",
 "The timeline below is indicative for a Full-time Academic Faculty hire "
 "starting at the beginning of a term; Part-time timelines compress as "
 "noted in §3.2. Working days exclude University holidays."),
 ("table", ([
 ["Day (relative to start date)", "Milestone"],
 ["Day -45 to -30", "Screening, teaching demonstration, and panel interview completed."],
 ["Day -30", "Conditional offer issued; 15-working-day document deadline begins."],
 ["Day -30 to -15", "Candidate submits documents; HRMO logs and flags gaps."],
 ["Day -15 to -10", "HRMO confirms document completeness; escalates unresolved gaps to the candidate and Department Chair."],
 ["Day -10 to -5", "Clearance results confirmed; contract or appointment paper prepared."],
 ["Day -5 to -2", "Contract signed; HRMO schedules orientation."],
 ["Day -1", "HRMO orientation and systems access provisioning."],
 ["Day 0", "First day of classes or service; Department-level orientation with the Chair."],
 ], [3.0, 6.2])),

 ("h2", "6. Incomplete Documents and Contingent Status"),
 ("p",
 ...
 "for a missing physical fitness certification -- these two items must be "
 "fully resolved before the first day."),

 ("h2", "7. Frequently Confused Points"),
 ("bullets", [
 ...
 "Part-time faculty follow the same six stages, not a separate, "
 "shorter process -- only the timing and orientation format differ "
 "(§3.2).",
 ]),

 ("h2", "8. Where to Get Help"),
 ("p",
